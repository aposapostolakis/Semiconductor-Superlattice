...
Uinas = str2double(parameters{3});
dalas = str2double(parameters{4});
dgaas = str2double(parameters{5});
dinas = str2double(parameters{6});


% Call the function with extracted parameters
SLmbdis(Ualas, Ugaas, Uinas, dalas, dgaas, dinas);
